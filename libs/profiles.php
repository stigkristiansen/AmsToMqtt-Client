...
trait Profiles {
    ...
    protected function RegisterProfileIntegerMin($Name, $Icon, $Prefix, $Suffix) {
        if (!IPS_VariableProfileExists($Name)) {
    ...
    protected function RegisterProfileInteger($Name, $Icon, $Prefix, $Suffix, $MinValue, $MaxValue, $StepSize) {
        ...
        $this->RegisterProfileInteger($Name, $Icon, $Prefix, $Suffix);
    ...
    protected function RegisterProfileFloatMin($Name, $Icon, $Prefix, $Suffix) {
    ...
    protected function RegisterProfileFloatEx($Name, $Icon, $Prefix, $Suffix, $Associations) {
        ...
        $this->RegisterProfileFloatMin($Name, $Icon, $Prefix, $Suffix);
